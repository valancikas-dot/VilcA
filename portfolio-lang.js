const portfolioTranslations = {
  lt: {
    ...
    fazero_title: 'Fazero – elektros instaliacijų testavimas',
    fazero_desc: 'Elektros instaliacijų bandymai, matavimų registravimas ir automatinis PDF protokolų generavimas.',
    taxlitas_title: 'Taxlitas – mokesčių apskaita',
    taxlitas_desc: 'Paprasta mokesčių apskaita smulkiam verslui: automatinės ataskaitos, išlaidų valdymas ir PVM skaičiavimas.',
